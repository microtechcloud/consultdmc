...
//custome middlware
// app.use(middleware.cache({root:"./static", store:"confused", cache:true}));
// app.use(confuse({root:"./static", store:"confused", cache:true,debug:true}));


 //set view engine and views directory
app.set("view engine","ejs");
app.set("views",path.join(__dirname,`${path.sep}..${path.sep}front-end`));
app.use("/",express.static(path.join(__dirname,`${path.sep}..${path.sep}front-end`)))
